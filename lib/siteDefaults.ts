export const siteDefaults = {
    ...
    our_targets: {
        ...
        href: "/targets",
        items: [
            { id: "1", name: "PROGRAM RETENTION", logo: "85%\nCOMPLETION", description: "Ensuring our participants achieve high program retention and successfully navigate the full six-month structured pathway to stability.", image: "/assets/branding/splash-image-011.jpg" },
            { id: "2", name: "EARLY INTERVENTION", logo: "50-60% EARNING\nIN 3 MONTHS", description: "Accelerating the transition from vulnerability to active income through market-aligned vocational training and early intervention.", image: "/assets/branding/splash-image-012.jpg" },
            { id: "3", name: "CAREER STABILITY", logo: "70% EARNING\nIN 6 MONTHS", description: "Facilitating long-term job placement and employer partnerships within 6 months to reduce household economic shocks.", image: "/assets/branding/splash-image-013.jpg" },
            { id: "4", name: "REVENUE EXPANSION", logo: "98% INCOME\nINCREASE", description: "Targeting significant financial improvement and revenue expansion for at least half of our program participants.", image: "/assets/branding/splash-image-014.jpg" },
            { id: "5", name: "ASSET BUILDING", logo: "100% SAVINGS\nCULTURE", description: "Reinforcing economic resilience by participating in structured savings groups and financial literacy education to build assets.", image: "/assets/branding/splash-image-011.jpg" },
            { id: "6", name: "COMMUNITY REACH", logo: "200 SERVED\nANNUALLY", description: "Scaling our community reach within Acholi Quarters to serve up to 200 young mothers and youth every year.", image: "/assets/branding/splash-image-012.jpg" },
            { id: "7", name: "CURRENT ENGAGEMENT", logo: "105 MOTHERS\nRECRUITED", description: "Actively engaging and supporting a growing cohort of 105 young mothers through our registered indigenous organization.", image: "/assets/branding/splash-image-013.jpg" },
            { id: "8", name: "COMMUNITY OWNERSHIP", logo: "15+ DEDICATED\nVOLUNTEERS", description: "Building community ownership by leveraging dedicated volunteers' local talent and hearts to drive our mission and operations.", image: "/assets/branding/splash-image-014.jpg" },
            { id: "9", name: "COST EFFECTIVENESS", logo: "$300-$350 PER\nPARTICIPANT", description: "Optimizing resources as a cost-effective investment to deliver trauma-informed counseling and vocational skills development.", image: "/assets/branding/splash-image-011.jpg" },
            { id: "10", name: "OPERATIONAL CAPACITY", logo: "$65K ANNUAL\nBUDGET", description: "Maintaining an operational capacity supported by a $65,000 annual operating budget to serve approximately 150 participants.", image: "/assets/branding/splash-image-012.jpg" },
            { id: "11", name: "EMPLOYMENT PIPELINE", logo: "16 TAILORING\nPLACEMENTS", description: "Demonstrating a strong employment pipeline through 16 successful job placements and long-term industry partnerships.", image: "/assets/branding/splash-image-013.jpg" },
            { id: "12", name: "STRUCTURED SUCCESS", logo: "6-MONTH COHORT\nMODEL", description: "Implementing a structured six-month cohort model to move participants from trauma stabilization to income activation in one community ecosystem.", image: "/assets/branding/splash-image-014.jpg" }
        ]
    },
    impact_milestones: {
        sectionLabel: "IMPACT MILESTONES",
        testimonials: [
            { id: "empowering-mothers", category: "Empowering Young Mothers", quote: "We registered and profiled 105 young mothers, documenting their skills and education to create targeted pathways for their emotional and economic stability.", role: "Community Data", company: "Radiant Rise Initiative", image: "/assets/images/profile_images/Frame 1.jpg" },
            { id: "formal-employment", category: "Securing Formal Employment", quote: "We secured 16 tailoring job placements and established a five-year partnership with Fine Spinners, creating a sustained employment pipeline through market-aligned skill-building.", role: "Economic Activation", company: "Radiant Rise Initiative", image: "/assets/images/profile_images/Frame 2.jpg" },
            { id: "healing-stabilization", category: "Healing and Stabilization", quote: "Because trauma impacts confidence and job retention, our six-month pathway begins with trauma-informed counseling, helping youth stabilize before building market-relevant skills.", role: "Emotional Recovery", company: "Radiant Rise Initiative", image: "/assets/images/profile_images/Frame 3.jpg" },
            { id: "financial-resilience", category: "Fostering Financial Resilience", quote: "Because savings are rare and income loss has immediate impacts, we reinforce retention through structured savings participation, building financial cushions to reduce household vulnerability.", role: "Household Resilience", company: "Radiant Rise Initiative", image: "/assets/images/profile_images/Frame 4.jpg" }
        ]
    },
    got_questions: {
        title: "Got Questions?",
        ...
        href: "#connect",
        items: [
            { id: "1", question: "What is the Radiant Rise Initiative?", answer: "Radiant Rise Initiative is a registered indigenous organization located in Acholi Quarters, Kampala, Uganda. Founded in July 2025, it operates as a community-owned household economic resilience model. Our primary mission is to equip youths and young mothers with the skills needed to empower them to uplift their communities and rise above adversity." },
            { id: "2", question: "What specific challenges does your organization address?", answer: "In informal urban settlements like Acholi Quarters, early pregnancy and youth unemployment converge, creating immense pressure that destabilizes entire households. We address the core problem of fragmented support systems, where vocational training, counseling, and job opportunities often exist in isolation. By replacing episodic aid with coordinated economic pathways, we help reduce vulnerability and unresolved trauma." },
            { id: "3", question: "How does your empowerment program work?", answer: "We operate a structured six-month cohort pathway designed around a specific Theory of Change. The pathway consists of four integrated stages: Stabilize (trauma-informed counseling), Build (market-aligned vocational skills), Activate (job placements and start-up toolkits), and Reinforce (savings participation and continuous follow-up)." },
            { id: "4", question: "Who benefits directly from your interventions?", answer: "Our primary beneficiaries are young mothers (aged 14–25), vulnerable youth, teenagers, and school dropouts residing in Acholi Quarters. Currently, we have actively recruited over 130 young mothers into our programs. We also actively engage community leaders to ensure inclusive, community-wide development." },
            { id: "5", question: "Why do you focus exclusively on Acholi Quarters?", answer: "Radiant Rise prioritized building a disciplined, repeatable household economic resilience model within one defined community. By focusing heavily on depth and measurable impact, we ensure that our interventions genuinely strengthen multiple lives and build intergenerational stability." },
            { id: "6", question: "How do you ensure participants find employment?", answer: "We bridge the gap between skills and livelihood through direct employer engagement, such as our five-year partnership with Fine Spinners. For entrepreneurship, we provide structured micro-enterprise toolkits to activate immediate income generation." },
            { id: "7", question: "How do you measure success?", answer: "We track data-driven targets for each cohort, including an 85% program completion rate and seeing 70% of participants secure a steady income within six months. We also aim for at least 50% of participants to increase their income by 25% or more." },
            { id: "8", question: "Is Radiant Rise a registered entity?", answer: "Yes, Radiant Rise Initiative is fully registered with the Uganda National NGO Bureau and operates under a valid permit. Our operations are supported by a local board, dedicated volunteers, and international well-wishers." }
        ]
    },
    gallery: {
        items: [
