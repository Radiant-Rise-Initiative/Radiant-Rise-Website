...
interface TheoriesOfChangeProps {
  title?: string;
  description?: string;
  items?: TheoryStage[];
}
      ...
      <div className="flex flex-col w-full overflow-hidden">
        {items.map((item, index) => (
          <div 
            ...
            style={{ backgroundColor: `rgba(0, 0, 0, ${(index + 1) * 0.05})` }}
          >
            <div className="max-w-[1280px] 2xl:max-w-[1440px] mx-auto w-full px-4 sm:px-12 lg:px-0">
              <motion.div 
              ...
              >
                <div className="md:col-span-1 pb-4 md:pb-0 mb-2 md:mb-0">
                   ...
                   <span className="text-white/30 text-[clamp(3.5rem,7.5vw,8rem)] leading-[0.8] font-normal tracking-[-0.04em]">{item.stage}</span>
                </div>
